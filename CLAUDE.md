...
**Surgical changes**
When modifying existing code, preserve surrounding style. Every changed line should trace directly to the user's request. Only remove code your changes rendered obsolete. Never create new styles, or components, without asking, if existing components exist reuse it for consistency.
